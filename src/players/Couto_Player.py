...
class Couto_Player(Player):
    ...
    def calculate_score(self, state):
        ...
        # print("SUM(NEUTRALS)", score)
        for col in neutrals:
            # print("FOR COLUMN %s\t progress_value: %s, advanced: %s, position_secured: %s"%(col, self.progress_value[col], self.number_cells_advanced_this_round_for_col(state, col), self.positions_player_has_secured_column(state, col)))
